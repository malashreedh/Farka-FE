    ...
    <main className="page-shell">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-14">
          <div className="fade-in-up">
            ...
            <h1 className="mt-6 max-w-4xl text-[clamp(3.2rem,7vw,6.6rem)] font-semibold leading-[0.95] tracking-[-0.06em] text-[color:var(--text)]">
              ...
              <span className="opacity-50">Now, let them work </span> 
            ...
            <div className="mt-10 grid max-w-xl grid-cols-3 gap-4">
              {trustStats.map((stat, index) => (
                <div key={stat.label} className={`panel-subtle rounded-[24px] p-4 fade-in-up stagger-${index + 1}`}>
                  ...
                  <p className="mt-2 text-[10px] uppercase tracking-[0.2em] text-[color:var(--muted-strong)]">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="panel-raised relative overflow-hidden rounded-[36px] p-6 md:p-8">
              ...
              <div className="relative">
                <div className="mb-6 flex items-center justify-between">
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] text-[color:var(--muted-strong)]">Path Analysis Found</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-[28px] border border-white/8 bg-[color:var(--surface)] p-5">
                    <p className="text-sm italic leading-7 text-[color:var(--text)]">
                      “I spent 7 years as an MEP lead in Dubai. I have savings and want to open a workshop in Butwal.”
                    </p>
                  </div>
                  
                  {/* The Synthesis/Analysis Visual */}
                  <div className="rounded-[28px] rounded-tl-md border border-[color:var(--line-strong)] bg-[color:var(--accent-soft)] p-5">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <p className="text-[9px] uppercase tracking-widest text-[color:var(--muted-strong)]">Market Need</p>
                            <p className="text-sm font-bold text-[color:var(--text)]">High Demand</p>
                        </div>
                        <div>
                            <p className="text-[9px] uppercase tracking-widest text-[color:var(--muted-strong)]">Eligibility</p>
                            <p className="text-sm font-bold text-[color:var(--text)]">SME Grant</p>
                        </div>
                    </div>
                    <div className="mt-3 flex items-center gap-2 border-t border-[color:var(--line-strong)] pt-3">
                        <BriefcaseBusiness size={14} className="text-[color:var(--accent)]" />
                        <p className="text-[10px] font-bold uppercase text-[color:var(--accent)]">18 Verified Matches Nearby</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <div className="rounded-[24px] border border-white/8 bg-[color:var(--surface)] p-4">
                    ...
                    <p className="mt-2 text-xs leading-6 text-[color:var(--muted)]">Local costs, real districts, and government schemes.</p>
                  </div>
                  <div className="rounded-[24px] border border-white/8 bg-[color:var(--surface)] p-4">
                    <div className="flex items-center gap-3">
                    ...
                    <p className="mt-2 text-xs leading-6 text-[color:var(--muted)]">No passwords or CVs. Just talk to get started.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 pt-10 md:px-8">
        ...
        <footer className="mt-8 flex flex-col gap-3 border-t border-white/8 pt-6 text-sm text-[color:var(--muted)] md:flex-row md:items-center md:justify-between">
          <p>FARKA फर्का • Nepal-US Hackathon 2026</p>
          <p className="uppercase tracking-[0.22em] text-[color:var(--muted-strong)]">Empowering the return to Nepal</p>
        </footer>
      </section>
    </main>
  );
